...
use crate::{mesh::CurveKind, surface::Surface};
...
impl Curve {
    ...
    pub fn kind(&self) -> CurveKind {
        match self {
            Self::Ellipse { kind, .. } => *kind,
            Self::Line => CurveKind::Line,
            Self::BSplineCurveWithKnots(_) | Self::NURBSCurve(_) => CurveKind::BSpline,
        }
    }
